...
[![crates.io](https://img.shields.io/crates/v/run_script.svg)](https://crates.io/crates/run_script) [![Build Status](https://travis-ci.org/sagiegurari/run_script?branch=master&svg=true)](http://travis-ci.org/sagiegurari/run_script) [![Build status](https://codecov.io/gh/sagiegurari/run-script/branch/master/graph/badge.svg)](https://ci.appveyor.com/project/sagiegurari/run-script) [![codecov](https://codecov.io/gh/sagiegurari/run_script/branch/master/graph/badge.svg)](https://codecov.io/gh/sagiegurari/run_script)<br>
